...
## Technologies: 
- <ins>Github (Version Control):<ins> linked my Google Shell Environment with my GitHub repo
- <ins>Flask (Python; Frotend & Backend):<ins> created a BMI Flask application
